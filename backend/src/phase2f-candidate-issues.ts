...
const issueWords=new Set(['banjir','genangan','tergenang','terendam','rendam','hujan','longsor','sampah','macet','kemacetan','rusak','kecelakaan','kebakaran','krisis','darurat','protes','demonstrasi','pencemaran','wabah','keluhan','gangguan']);
