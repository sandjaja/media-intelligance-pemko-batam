(()=>{
 ...
 document.addEventListener('click',e=>{if(!e.target.closest?.('#reportPrint'))return;e.preventDefault();e.stopImmediatePropagation();ensurePrintStyle();applyBranding();window.print()},true);
