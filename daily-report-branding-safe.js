(()=>{
 ...
 function ensurePrintStyle(){if(document.getElementById('phase2g-report-print-style'))return;const s=document.createElement('style');s.id='phase2g-report-print-style';s.textContent='@media print{#reports>div>div:first-child{display:none!important}#reportOutput{margin-top:0!important}#printableReport{margin-top:0!important}}';document.head.appendChild(s)}
 ...
 function scheduleBranding(){ensurePrintStyle();setTimeout(applyBranding,250);setTimeout(applyBranding,900)}
