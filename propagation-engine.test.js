...
assert(similarity('metro investasi industri meningkat','metro investasi industri meningkat')===1);
assert(similarity('metro investasi industri meningkat','cuaca hujan laut')<0.22);
